                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('quizes.update', $quiz->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="no_question" type="text" class="form-control @error('no_question') is-invalid @enderror" name="no_question" value="{{ $quiz->no_question }}" required autocomplete="no_question" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="score_question" type="text" class="form-control @error('score_question') is-invalid @enderror" name="score_question" value="{{ $quiz->score_question }}" required autocomplete="current-score_question">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="passing_score" type="text" class="form-control @error('passing_score') is-invalid @enderror" name="passing_score" value="{{ $quiz->passing_score }}" required autocomplete="passing_score" autofocus>
